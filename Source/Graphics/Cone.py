...
class Cone(Actor):
    ...
    def generateGeometry(self):
        ...
        l    = np.sqrt( self._height * self._height + self._radius * self._radius)
        cosn = (self._height/l)
        sinn = (self._radius/l)
        ...
        for i in list(range(self._resolution)):
            ...
            texcoords.append([x[i+1]/(2*self._radius) + 0.5, z[i+1]/(2*self._radius) + 0.5])
        ...
        self._texcoords = np.concatenate((texcoords_side, texcoords_bot))
